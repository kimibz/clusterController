...
if (dayspring) {
    throw new Error("XIGUA can not be loaded, it already exists.");
} else {
    dayspring = {};
}
if ("undefined" === typeof jQuery) { 
    throw new Error("XIGUA\'s javaScript requires jQuery.");
}
if ("undefined" === typeof xigua_local ) {
     throw new Error("XIGUA\'s javaScript requires i18n file.");
}
